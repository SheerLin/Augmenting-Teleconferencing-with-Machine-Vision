...
class Undistortion2:
    ...
    def initialize(self):
        ...
        if self.chessboard_folder_path:
            ...
            self.img_points, self.obj_points = Undistortion2.init_img_obj_points_from_chessboards(
            ...
            self.img_points, self.obj_points = Undistortion2.deserialize(self.img_points_path, self.obj_points_path)
    ...
    def __init_profile_mapping(self):
        ...
        self.device_name = Undistortion2.find_device_id_by_cam_device_number(self.cam_device_number)
        return
    ...
    def __select_profile(self):
        ...
        if len(self.device_to_profile.keys()) > 0:
            ...
            list_of_devices = Undistortion2.get_usb_devices()
            ...
            if not no_profile:
                id_to_profile = Undistortion2.profile_map_formatter(available_profiles_map, "available_profiles_map")
                while True:
                    user_selected = input()
    ...
    def profile_map_formatter(profile_map: dict, name: str):
        ...
        for cur_device, cur_pair_list_or_set in profile_map.items():
            ...
            print(padding + Undistortion2.get_usb_device(device_id=cur_device))
    ...
    def chessboard_path_to_profile(set_up_chessboard_path, img_points_path, obj_points_path, devices: list):
        ...
        img_points, obj_points = Undistortion2.init_img_obj_points_from_chessboards(set_up_chessboard_path)
        Undistortion2.serialize(img_points, obj_points, img_points_path, obj_points_path)

        if devices and len(devices) > 0:
            Undistortion2.save_device_to_profile(devices, img_points_path, obj_points_path)
...
if __name__ == "__main__":
    ...
    Undistortion2.chessboard_path_to_profile(chessboard_path, img_path, obj_path, device_list)
